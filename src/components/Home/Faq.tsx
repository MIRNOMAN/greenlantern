...
import backround_icon from "@/assets/Backround/Logo.png";

export default function Faq() {
  return (
    <div className="container mx-auto px-4 py-12">
      <div className="flex mx-auto border w-[80px] justify-center border-[#ECECEC] rounded-2xl items-center">
      ...
      <div className="relative md:mt-[180px] rounded-lg overflow-hidden">
        <Image
          src={backround_image}
          alt="Classroom"
          width={900}
        ...
        <div className="absolute inset-0 bg-black/60 flex flex-col items-center justify-center text-white">
          ...
          <button className="mt-4 md:px-8 px-4 md:py-3 py-1 border border-orange-500 text-white rounded-full hover:bg-orange-500 transition-colors">
            Get In Touch
          </button>
        </div>
      </div>
