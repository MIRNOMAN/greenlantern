      ...
      <div className="bg-white p-6 rounded-lg border border-[#ECECEC]">
        ...
        >
          {items.map((item, index) => (
            <StatusItem key={index} title={item.title} status={statusType} />
          ))}
        </div>
      </div>
    </div>
...
export default function UserDashboard() {
  const completedItems = [
    { title: "Pharmacy Credentialing Point of Contact" },
    { title: "Pharmacy Legal Name" },
    { title: "Pharmacy Billing Address" },
    { title: "Pharmacy Contact Information" },
    { title: "Pharmacy DEA License" },
  ...
  const pendingItems = [
    ...
    { title: "Pharmacy Professional Information" },
    { title: "State Plan Credentialing" },
    { title: "Federal Compliance Documentation" },
