    ...
    <section className="relative md:h-[620px]  w-full">
      ...
      <div className="relative z-10 container mx-auto px-4  pb-16  flex flex-col justify-center">
        ...
        <div className=" md:pt-[220px] pt-[130px]">
          {/* Heading */}
          <div className="flex border w-[80px] justify-center p-1 border-[#ECECEC] rounded-2xl items-center">
              <span className="h-1.5 w-1.5 rounded-full bg-[#F5E663]"></span>
              <span className="ml-2 text-white font-medium">About</span>
            </div>
          <h1 className="text-4xl md:text-[80px] md:pt-[20px] pt-[30px] font-semibold md:leading-[88px] text-white mb-6">
          About Our Credentialing
          </h1>
